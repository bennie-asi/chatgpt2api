...
<p align="center">
  <img src="https://img.shields.io/badge/version-v3.1.0-111827" alt="Version v3.1.0" />
...
<p align="center">
  <a href="https://github.com/yukkcat/chatgpt2api/releases/tag/v3.1.0">v3.1.0 Release</a>
...
To install the fixed `v3.1.0` release:

```bash
curl -fsSL https://raw.githubusercontent.com/yukkcat/chatgpt2api/v3.1.0/deploy/install.sh | sudo bash -s -- --branch v3.1.0
```
